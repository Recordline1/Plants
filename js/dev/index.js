...
function initSliders() {
  if (document.querySelector(".plants__slider")) {
    new Swiper(".plants__slider", {
      ...
      */
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".plants-button-prev",
        nextEl: ".plants-button-next"
      },
      // Брейкпоінти
      breakpoints: {
        320: {
  ...
  if (document.querySelector(".slider-best")) {
    new Swiper(".slider-best", {
      // <- Вказуємо склас потрібного слайдера
      // Підключаємо модулі слайдера
      // для конкретного випадку
      modules: [Navigation, Pagination],
      ...
      */
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".slider-best-button-prev",
        nextEl: ".slider-best-button-next"
      },
      /*
      // Брейкпоінти
      breakpoints: {
  ...
  if (document.querySelector(".customer__row")) {
    new Swiper(".customer__row", {
      // <- Вказуємо склас потрібного слайдера
      // Підключаємо модулі слайдера
      // для конкретного випадку
      modules: [Scrollbar],
...
function counter(swiper) {
  const current = swiper.realIndex + 1;
  const total = swiper.slides.length;
  document.querySelector(".current").textContent = current.toString().padStart(2, "0");
  document.querySelector(".total").textContent = total.toString().padStart(2, "0");
}
...
function menuInit() {
  document.addEventListener("click", function(e) {
    ...
    if (!e.target.closest(".menu__body") && menuOpen) {
      bodyLockToggle();
